<?php /* Smarty version Smarty-3.1.11, created on 2014-02-15 21:02:13
         compiled from "application/views/templates/user/user.tpl" */ ?>
<?php /*%%SmartyHeaderCode:84338379452ff7365bf3520-64937788%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'bc22b3d2f93bc85d156c7eead36c77851d1dc4ff' => 
    array (
      0 => 'application/views/templates/user/user.tpl',
      1 => 1392470357,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '84338379452ff7365bf3520-64937788',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52ff7365df04d8_66579805',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52ff7365df04d8_66579805')) {function content_52ff7365df04d8_66579805($_smarty_tpl) {?><script src="<?php echo $_smarty_tpl->tpl_vars['data']->value['base_js'];?>
user.js"></script>
<div class="row-fluid">
    <div class="navbar">
...
user/<?php echo $_smarty_tpl->tpl_vars['data']->value['function'];?>
" method="post"  enctype="multipart/form-data">
					<input type="hidden" name="data[iUserId]" value="<?php echo $_smarty_tpl->tpl_vars['data']->value['user']['iUserId'];?>
" id="iUserId">
					<fieldset>
					<legend><?php if ($_smarty_tpl->tpl_vars['data']->value['function']!='create'){?>Edit <?php }else{ ?>Add <?php }?>User</legend>
