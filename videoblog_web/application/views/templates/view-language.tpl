<form name="frmlist" id="frmlist" action="{$data.base_url}language/action_update" method="post">
        ...
        <div class="block">
            ...
            <div class="block-content collapse in">
                ...
                <div class="row-fluid">
                    ...
                    <div class="span6">
                        <div class="pull-right">
                            ...
                            <!-- <button type="button" id="btn-add" onclick="addme('{$data.base_url}language/create');"  class="btn btn-inverse bottom-buffer">Add New</button> -->
                ...
                <table class="table  table-bordered table-striped ">
                    ...
                    <tr>
                        <td><input type="checkbox" name="iId[]" id="iId" value="{$data.language[i].iLanguageId}"></td>
                        <td>{$data.language[i].vLanguage}</td>
                        <td>{$data.language[i].vLangCode}</td>
                        <td>{$data.language[i].eStatus}</td>
                        <td><a href="{$data.base_url}language/update/{$data.language[i].iLanguageId}">Edit</a></td>
                    </tr>
                    {/section}
                    {else}
                    <tr>
