    ...
    <div class="span12">
        <div class="block">
            ...
            <div class="block-content collapse in">
				<form class="form-horizontal" id="frmlanguage" action="{$data.base_url}language/update" method="post">
					<input type="hidden" id="iLanguageId" name="data[iLanguageId]" value="{$data.language.iLanguageId}">
					<fieldset>
	                        ...
	                        <label class="control-label">Status</label>
	                            <div class="controls">
	                                <select class="input-large" name="data[eStatus]">
	                                	...
	                                	<option value="{$eStatuses[i]}" {if $eStatuses[i] eq $data.language.eStatus}selected="selected"{/if}>{$eStatuses[i]}</option>
	                                	{/section}
	                                </select>
	                            </div>
	                    </div>
