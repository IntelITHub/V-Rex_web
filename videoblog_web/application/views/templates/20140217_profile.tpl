    ...
    <div class="span12">
        <div class="block">
            ...
            <div class="block-content collapse in">
				<form class="form-horizontal" id="frmuser" action="{$data.base_url}Profile" method="post"  enctype="multipart/form-data">
					<input type="hidden" name="data[iUserId]" value="{$data.user.iUserId}" id="iUserId">
					<fieldset>
					<legend>{if $data.function neq 'create'}Edit {else}Add {/if}Profile</legend>
