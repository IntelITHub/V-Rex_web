    ...
    <div class="span12">
        <div class="block">
            ...
            <div class="block-content collapse in">
				<form class="form-horizontal" id="frmrole" action="{$data.base_url}role/{$data.function}" method="post">
					<input type="hidden" name="data[iRoleId]" value="{$data.role.iRoleId}">
					<fieldset>
					<legend>{if $data.function neq 'create'}Edit {else}Add {/if} Role</legend>
