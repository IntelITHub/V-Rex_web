...
<form class="form-horizontal" id="frmmember" action="{$data.base_url}member/update" method="post" enctype="multipart/form-data">
	...
	<fieldset>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="text" class="span3" id="vPhone" name="data[vPhone]" value="{$data.member.vPhone}">
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" for="typeahead">Url</label>
			<div class="controls">
				<input type="text" class="span3" id="vURL" name="data[vURL]" value="{$data.member.vURL}">
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" for="typeahead">Description</label>
			<div class="controls">
				<input type="text" class="span3" id="tDescription" name="data[tDescription]" value="{$data.member.tDescription}">
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<select class="input-large" name="data[iCountryId]" id="iCountryId">
					...
					<option value="{$data.all_country[i].vCountry}" {if $data.all_country[i].vCountry eq $data.member.iCountryId}selected="selected"{/if}>{$data.all_country[i].vCountry}</option>
					{/section}
				</select>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<select class="input-large" name="data[iStateId]" id="iStateId">
					...
					<option value="{$data.all_state[i].vState}" {if $data.all_state[i].vState eq $data.member.iStateId}selected="selected"{/if}>{$data.all_state[i].vState}</option>
					{/section}
				</select>
			</div>
		</div>
